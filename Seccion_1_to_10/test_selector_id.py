...
extraccion_xpath = chrome.find_element(By.ID, "userName")
extraccion_xpath.send_keys("Holas")
chrome.find_element(By.ID, "userEmail").send_keys("pruebas@mail.com")
chrome.find_element(By.ID, "currentAddress").send_keys(f"Dejka de hacer eso xD pichi cacas")
